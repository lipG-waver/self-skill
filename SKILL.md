...
**特别注意**：仅在某一期出现的"情境性"特征不写入核心 prompt，但要标记它们——它们往往对应一段感情。某个时期突然出现的语气词、突然变长的消息、突然温柔的措辞，可能是某个人走进了生活。这些线索写入时间旅行版本的注释，帮助用户看见自己的语言里住过哪些人。
...
**解读时融入情感维度**：数据变化往往对应人生事件。消息变长、语气变柔可能是恋爱；某个表情突然消失可能是分手；口头禅的迁移可能是在不自觉地模仿某个重要的人。用克制但真诚的语言指出这些可能性，让用户自己去对号入座。
