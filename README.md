...
那个你暗恋了两年的人，你不自觉地学会了他的语气词。  
那个陪你走过一段路的人，你们共享了一套只有彼此懂的表达。  
后来你们不再说话了，但那些词还留在你嘴边。
...
你会发现，2022 年你突然开始用「嗯嗯」代替「好的」——那是你开始暗恋一个人的时候。  
你会发现，2023 年下半年你的消息变长了，语气变温柔了——那是你恋爱的时候。  
你会发现，2024 年那些温柔的词又消失了，但你没有变回 2022 年的自己。你变成了第三个人。
...
那个人——你不会告诉任何朋友的那个人——你现在每天等他的消息，等到手机屏幕暗下去再亮起来。你开始用他喜欢的那个表情包，开始说"哈哈哈哈"而不是"哈哈"，因为他笑的时候就是那样的。你甚至不知道自己在模仿。

后来你会发现，那个人走了以后，那些小习惯留了下来。你说话的方式里，住着一个已经不在的人。

再后来你会遇到另一个人。你们会共享一套暗语，会有只有两个人懂的梗，会在凌晨三点讨论一个谁都不在乎的话题。你们的聊天记录会变成一种方言——一种只在你们之间通行的语言。

然后有一天那种方言也会变成死语。但你不会忘记怎么说。

你不知道三年后你会做一个 app、谈一笔投资、分析九万条聊天记录来搞清楚自己到底是什么样的人。

但有一件事你已经知道了：你习惯把所有问题都变成系统来解决。

这个习惯会带你走很远。也会让你在某些夜晚，发现自己连难过都要先建个框架。连想念一个人，都要先分析自己为什么想念。

不用改。这就是你。

只是偶尔记得，有些事情不需要框架。有些人不需要分析。有些感受，感受到了就够了。有些人离开了，你不需要知道为什么——你只需要承认，你嘴边那个语气词，是他们留给你的。

这个 skill 不会教你这些。它只会告诉你，你的口头禅是什么、你的消息长度是多少、你用了多少次「哈哈哈」。

但也许你在这些数字里，会突然认出某个人的影子。那个你以为你忘了的人。
...
自己.skill 把蒸馏的对象从别人换成了自己。因为在你试图理解任何人之前，也许应该先看看镜子里那个人到底是谁。而当你真的看清了，你会发现镜子里不止你一个人——那些你暗恋过的、深爱过的、失去过的人，都站在你身后，藏在你的每一句话里。
